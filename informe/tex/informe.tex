...
\begin{enumerate}
\item Para calcular el ganador de un anio espec\'ificio se calcula el que calificaci\'on tiene ese anio y el que mas pago al sitio y esos datos alcanzan para que el departamento de marketing haga una ponderaci\'on y calcule el ganador
